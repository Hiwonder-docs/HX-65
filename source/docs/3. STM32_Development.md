...
3. Click the ① ”**...**” icon and select the HEX file to be programmed from the path: [**Serial_Servo\MDK-ARM\Serial_Servo**](https://drive.google.com/drive/folders/1dwBYlEN0qjch78LfS1gWCoQSE9BQTGm3).
